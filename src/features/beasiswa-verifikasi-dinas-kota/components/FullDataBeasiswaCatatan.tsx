...
interface FullDataBeasiswaCatatanProps {
  ...
  // ✅ prop baru: tentukan mode verifikator untuk pre-populate dokumen
...
const FullDataBeasiswaCatatan: FC<FullDataBeasiswaCatatanProps> = ({
  ...
  return (
    <>
          ...
          <div className="space-y-8">
            <div>
              <h4 className="font-semibold text-base mb-4 flex items-center gap-2">
                <User className="w-5 h-5" /> Data Ayah
              </h4>
            ...
            <div className="border-t pt-6">
              <h4 className="font-semibold text-base mb-4 flex items-center gap-2">
                <User className="w-5 h-5" /> Data Ibu
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 pl-7">
                <InfoItem
                  icon={User}
      ...
      {/* Persyaratan Umum — dengan verifikatorMode dari parent */}
            ...
            <div className="space-y-3">
              {persyaratan_umum.map((dokumen, index) => (
                <KesesuaianDokumen
                  ...
                  verifikatorMode={verifikatorMode} // ✅ diteruskan dari props
                />
              ))}
            </div>
          </>
