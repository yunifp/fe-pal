...
export const getColumns = (
  ...
  },
  {
    ...
    header: "Nama Dokumen",
    cell: ({ row }) => (
      <div className="font-medium text-gray-800 whitespace-normal break-words min-w-[200px] max-w-[350px]">
  ...
  },
  {
    ...
    header: "Status Aktif",
    cell: ({ row }) => <span className="whitespace-nowrap">{row.original.status_aktif === "Y" ? "Ya" : "Tidak"}</span>,
  },
  {
    accessorKey: "is_required",
    header: "Wajib Isi",
    cell: ({ row }) => <span className="whitespace-nowrap">{row.original.is_required === "Y" ? "Ya" : "Tidak"}</span>,
  },
  {
