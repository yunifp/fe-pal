...
const axiosInstanceBeasiswa = axios.create({
  baseURL: baseUrl,
  timeout: 60000, // ✅ PERBAIKAN: Diubah dari 40000 menjadi 60000 (1 menit)
  headers: {
...
// Request interceptor
axiosInstanceBeasiswa.interceptors.request.use((config) => {
      ...
      if (isRefreshing) {
        return new Promise((resolve, reject) => {
          ...
          .then((token) => {
            ...
            return axiosInstanceBeasiswa(originalRequest);
          })
...
export default axiosInstanceBeasiswa;